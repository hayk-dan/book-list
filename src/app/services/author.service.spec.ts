...
describe('AuthorService', () => {
  ...
  it('should get authors', () => {
    ...
    service.getAuthors().pipe(first()).subscribe(authors => {
  ...
  it('should create a new author', () => {
    ...
    service.createAuthor(newAuthor).pipe(first()).subscribe(author => {
  ...
  it('should update an author', () => {
    ...
    service.updateAuthor(1, updatedAuthor).pipe(first()).subscribe(author => {
  ...
  it('should delete an author', () => {
    ...
    service.deleteAuthor(authorId).pipe(first()).subscribe(response => {
